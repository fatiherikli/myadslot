...
from myads.core.forms import CustomForm

class PasswordChangeForm(BasePasswordChangeForm, CustomForm):
    """
    mixin classess for as_div method.
    """
    pass


class ProfileEditForm(forms.ModelForm, CustomForm):
    class Meta:
        model = User
